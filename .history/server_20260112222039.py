...
def load_items():
    if USER_FILE.exists():
        try:
            ...
            base_time = now - __import__('timedelta', fromlist=['timedelta'], level=0)(days=30)
            ...
            for idx, it in enumerate(raw):
                ...
                if 'abbreviation' in it or 'type' not in it:
                    ...
                    if 'created_at' not in new:
                        ...
                        artificial_time = base_time + __import__('timedelta', fromlist=['timedelta'], level=0)(hours=idx)
